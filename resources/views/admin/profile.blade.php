			...
			<div class="ps-3">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0 p-0">
						<li class="breadcrumb-item"><a href="{{ url('/admin/profile') }}"><i class="bx bx-home-alt"></i></a>
						</li>
			...
			<div class="main-body">
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column align-items-center text-center">
									...
									<img src="{{ asset('uploads/profile/' . Auth::user()->profile) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" height="110">
									@else
									<img src="{{ asset('assets/images/avatars/not-found.png') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" height="110">
									@endif
								...
								<ul class="list-group list-group-flush">
									...
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										...
										<span class="text-secondary">{{ Auth::user()->git_profile }}</span>
									</li>
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										...
										<span class="text-secondary">{{ Auth::user()->twitter_profile }}</span>
									</li>
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										...
										<span class="text-secondary">{{ Auth::user()->insta_profile }}</span>
									</li>
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										...
										<span class="text-secondary">{{ Auth::user()->fb_profile }}</span>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-lg-8">
						<div class="card">
							<div class="card-body">
								<form id="profile_form" method="post" action="{{ url('/admin/profile/update') }}" enctype="multipart/form-data">
									@csrf
									<div class="row mb-3">
										<div class="col-sm-3">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9 text-secondary">
											<!-- File Input -->
											<input name="profile" type="file" class="form-control" id="profile_picture" onchange="previewImage(event)">
									...
									<div class="row mb-3">
										<div class="col-sm-3">
											<h6 class="mb-0">Insta Profile</h6>
										</div>
										<div class="col-sm-9 text-secondary">
											<input name="insta_profile" type="text" class="form-control" value="{{ Auth::user()->insta_profile }}">
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
											<h6 class="mb-0">Fb Profile</h6>
										</div>
										<div class="col-sm-9 text-secondary">
											<input name="fb_profile" type="text" class="form-control" value="{{ Auth::user()->fb_profile }}">
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
											<h6 class="mb-0">Twitter Profile</h6>
										</div>
										<div class="col-sm-9 text-secondary">
											<input name="twitter_profile" type="text" class="form-control" value="{{ Auth::user()->twitter_profile }}">
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
										...
										<div class="col-sm-9 text-secondary">
											<input name="linkdin_profile" type="text" class="form-control" value="{{ Auth::user()->linkdin_profile }}">
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
										...
										<div class="col-sm-9 text-secondary">
											<input name="git_profile" type="text" class="form-control" value="{{ Auth::user()->git_profile }}">
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
										...
										<div class="col-sm-9 text-secondary">
											<input name="website" type="text" class="form-control" value="{{ Auth::user()->website }}">
										</div>
									</div>
									<div class="row">
										<div class="col-sm-3"></div>
										<div class="col-sm-9 text-secondary">
											<input type="button" name="submit" class="btn btn-primary px-4" value="Save Changes">
										</div>
									</div>
								</form>
							</div>
